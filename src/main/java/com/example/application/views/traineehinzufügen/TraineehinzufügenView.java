package com.example.application.views.traineehinzufügen;
...
@PageTitle("Trainee hinzufügen")
@Route("person-form")
@Menu(order = 0, icon = LineAwesomeIconUrl.USER)
@AnonymousAllowed
public class TraineehinzufügenView extends Composite<VerticalLayout> {

    public TraineehinzufügenView() {
